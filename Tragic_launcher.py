...
"""
in this code we have the rvo connection with the view 3 terminal 
"""
...
def _run_simulation(script_name, params, mask_path, zone_config_path,
    ...
    # RVO needs positional args; others use hardcoded paths
    script_args = {
...
class View3_Simulation(QWidget):
    ...
    def _view_report(self):
        ...
        dlg.setWindowTitle("Simulation Report")
        dlg.setText("Evacuation Analysis Report")
        dlg.setDetailedText(text)
        dlg.setStandardButtons(QMessageBox.StandardButton.Ok)
        dlg.setSizeGripEnabled(True)
        dlg.setStyleSheet("QTextEdit { min-width: 900px; min-height: 600px; font-family: monospace; font-size: 10pt; }")
        dlg.exec()
